...
/* Define to 1 if you have the declaration of 'PGRES_TUPLES_CHUNK', and to 0
   if you don't. */
#define HAVE_DECL_PGRES_TUPLES_CHUNK 1
...
/* Define to 1 if libpq has the 'PQchangePassword' function (PostgreSQL 17 or
   later). */
#define HAVE_PG_CHANGE_PASSWORD 1

/* PostgreSQL 17 or later */
#define HAVE_PG_CLOSE_STMT 1
...
#define PHP_BUILD_SYSTEM "Linux arch-nspawn-33499 6.19.11-arch1-1 #1 SMP PREEMPT_DYNAMIC Thu, 02 Apr 2026 23:33:01 +0000 x86_64 GNU/Linux"
...
#define PHP_MYSQL_UNIX_SOCK_ADDR "/run/mysqld/mysqld.sock"
...
/* The 'uname -a' output. */
#define PHP_UNAME "Linux arch-nspawn-33499 6.19.11-arch1-1 #1 SMP PREEMPT_DYNAMIC Thu, 02 Apr 2026 23:33:01 +0000 x86_64 GNU/Linux"
