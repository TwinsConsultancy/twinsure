...
if (!class_exists('MongoDB\\Driver\\Manager')) {
    class Manager {
        ...
        public function executeQuery(string $namespace, \MongoDB\Driver\Query $query): \MongoDB\Driver\Cursor { return new \MongoDB\Driver\Cursor(); }
        public function executeBulkWrite(string $namespace, \MongoDB\Driver\BulkWrite $bulk): \MongoDB\Driver\WriteResult { return new \MongoDB\Driver\WriteResult(); }
        public function executeCommand(string $db, \MongoDB\Driver\Command $command): \MongoDB\Driver\Cursor { return new \MongoDB\Driver\Cursor(); }
    }
}
